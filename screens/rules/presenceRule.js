...
export default class presenceRule extends Component {
  render() {
    return (
        <View style={{flex:1}}>
            <View style={{flex:0.5, backgroundColor:'#527fe2', justifyContent:'center', alignItems:'center', borderBottomLeftRadius: 20, borderBottomRightRadius: 20}}>
                <Image source={require('../presenca.png')} style={{width:155, height:155}}/>
                <Text style={{color: '#ffffff', fontWeight: 'bold', fontSize:15}}>Sensor de Presença</Text>
            ...
            <TouchableOpacity style={{backgroundColor:'#527fe2', marginRight:20, marginLeft:20, borderRadius:15, marginTop:50, padding:10}}>
